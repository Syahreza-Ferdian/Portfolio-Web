...
function About() {
    ...
    return (
        <>
            <div className="offcanvas offcanvas-bottom vh-100" tabIndex="-1" id="offcanvas-about" aria-labelledby="offcanvasAboutLabel">
                <div className="offcanvas-header flex-row-reverse">
                    <button type="button" className="btn-close btn-close-white" data-bs-dismiss="offcanvas" aria-label="Close"></button>
                </div>
                <div className="offcanvas-body small">
                    <h4 className="offcanvas-title text-center fw-bold" id="offcanvasAboutLabel">About Me</h4>
                        ...
                        <div className="container">
                            <div className="row justify-content-center">
                                ...
                                <div className="col-12 col-md-7">
                                    <p className="fs-6 mb-4" style={{ textAlign: "justify" }}>I am an Information Technology student at Brawijaya University with a strong
                    ...
                    <h4 className="offcanvas-title text-center fw-bold mt-5" id="offcanvasAboutLabel">Skills</h4>
