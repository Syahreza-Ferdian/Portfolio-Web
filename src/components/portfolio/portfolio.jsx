            ...
            <div className="portfolio-header d-flex flex-column flex-lg-row container-fluid justify-content-evenly">
              ...
              <div className="portfolio-header-text ms-lg-3 text-center text-lg-start">
                <p className="portfolio-header-desc fs-6 lh-lg">
                  My projects encompass a variety of technologies and
                  frameworks, showcasing my adaptability and problem-solving
                  skills. I have experience building backend systems using
                  Golang and Laravel, developing mobile applications with Java,
                  and crafting dynamic web applications. Notable projects
                  include a freeroam gamemode for GTA San Andreas Multiplayer, a
                  car rental web application, and an AI-powered learning
                  platform. My focus is on creating efficient, secure, and
                  scalable systems with features like RESTful APIs, payment
                  gateway integration, and real-time data processing. Below are
                  some of my highlighted projects, with repository links
              ...
              <div className="row justify-content-md-end">
                ...
                <div className="col-auto">
                  ...
                  <select
                    ...
                    onChange={(e) =>
                      setFilterProject(JSON.parse(e.target.value))
                    }
                  >
