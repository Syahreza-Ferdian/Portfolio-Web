                ...
                <div className="offcanvas-body small">
                    ...
                    <div className="container my-5">
                        <div className="row">
                            ...
                            <div className="col-md-6 mb-4">
                                <div
                                    className="card-contact p-4 rounded-4 bg-dark"
                                    data-bs-theme="dark"
                                >
                                    <h2>Contact Info</h2>
                                    <p>
                                        Always available for freelance work if
                                        the right project comes along, feel free
                                        to contact me!
                                    </p>
                                    <p>
                                        <strong>Name:</strong> Syahreza Fisti
                                        Ferdian
                                    </p>
                                    <p>
                                        <strong>Call Me:</strong> +62
                                        895-4149-49161
                                    </p>
                                    <p>
